    ...
    <footer className="bg-[#e9e9e9] pt-24 pb-12 px-6 md:px-12 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-black text-white rounded-[3rem] p-12 md:p-24 relative overflow-hidden mb-24">
          ...
          <div className="relative z-10 max-w-2xl">
            <h2 className="text-5xl md:text-8xl font-extrabold tracking-tighter leading-[0.9] mb-8 uppercase">
              Inizia il tuo <br /> <span className="important-word italic">Percorso</span> oggi.
            </h2>
            <p className="text-lg md:text-xl opacity-60 mb-12 max-w-md">
              Il tuo corpo ti ringrazier&agrave;. Prenota la tua prima visita osteopatica.
            </p>
            <button
              onClick={onBookClick}
          ...
          <div className="absolute bottom-12 right-12 hidden lg:block opacity-20">
            <svg viewBox="0 0 200 200" className="w-64 h-64 animate-spin-slow">
              ...
              <text className="text-[14px] uppercase font-bold tracking-[0.2em] fill-white">
                <textPath href="#circlePath">Studio Osteopatia • Giulia Patti • Catania • </textPath>
              </text>
            </svg>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-black/10 pb-12 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-2xl font-black uppercase tracking-tighter">Studio Osteopatia</span>
            </div>
            <p className="text-black/50 max-w-sm mb-8">
              Studio di Osteopatia professionale a Catania. Trattamenti personalizzati per il tuo benessere.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 font-bold text-sm">
              <li><a href="#" onClick={(e) => { e.preventDefault(); window.scrollTo({top: 0, behavior: 'smooth'}); }} className="hover:text-[#496da1] transition-colors">Chi Sono</a></li>
              <li><a href="#" onClick={(e) => { e.preventDefault(); if(onCoursesClick) onCoursesClick(); }} className="hover:text-[#496da1] transition-colors">I Miei Servizi</a></li>
              <li><a href="#testimonials" className="hover:text-[#496da1] transition-colors">Recensioni</a></li>
              <li><a href="#location" className="hover:text-[#496da1] transition-colors">Dove Sono</a></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] font-bold uppercase tracking-widest opacity-40">
          <p>&copy; 2026 Studio Osteopatia Giulia Patti. Tutti i diritti riservati</p>
